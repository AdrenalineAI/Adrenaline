...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_witness_block_size(self):
        ...
        # limit
        # ADRENALINE: scale to blocksize proportion
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # ADRENALINE: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def run_test(self):
        ...
        # ADRENALINE: Disable test due to occasional travis issue
