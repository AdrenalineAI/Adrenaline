...
Below are some notes on how to build OpenBlock Core for Windows.
...
way. This will install to `c:\workspace\openblock`, for example:

    make install DESTDIR=/mnt/c/workspace/openblock
