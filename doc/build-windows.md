...
Below are some notes on how to build ADRENALINE Core for Windows.
...
way. This will install to `c:\workspace\adrenaline`, for example:

    make install DESTDIR=/mnt/c/workspace/adrenaline
